        ...
        <main class="main">
            <div class="katalog__container">
                <div class="katalog__content">
                    <?php while($pizza = mysqli_fetch_assoc($result_pizza)){ ?>
                    <ul class="katalog__particle particle">
                        ...
                        <div class="particle__footer">
                            ...
                            <button data-id = "pizza<?php echo $pizza['id']; ?>" class="particle__button-plus"></button>
                            <button data-id = "pizza<?php echo $pizza['id']; ?>" class="particle__button-minus"></button>
                        </div>
                    </ul>
                    <?php } ?>
                </div>
