...
$result_drinks = mysqli_query($inclutions, "SELECT * FROM `drinks`");
?>
        ...
        <main class="main">
            <div class="katalog__container">
                <div class="katalog__content">
                    <?php while($pizza = mysqli_fetch_assoc($result_drinks)){ ?>
                        <ul class="katalog__particle particle">
                            ...
                            <div class="particle__footer">
                                ...
                                <button data-id = "drink<?php echo $pizza['id']; ?>" class="particle__button-plus"></button>
                                <button data-id = "drink<?php echo $pizza['id']; ?>" class="particle__button-minus"></button>
                            </div>
                        </ul>
                    <?php } ?>
                </div>
